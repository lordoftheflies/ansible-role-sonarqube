---
name: Test plan
about: Step-by-step description of the test plans.
title: "[TEST-PLAN] "
labels: test-plan
assignees: ${assignee1}
---
...
[Here is an example test plan](https://gitlab.cherubits.hu/development/issues/50353)
...
Example (from https://gitlab.cherubits.hu/development/issues/50353):
* Repository is
  * Intuitive
...
When adding new automated tests, please keep [testing levels](https://journal.cherubits,hu/testing_guide/testing_levels.html)
in mind.
-->
